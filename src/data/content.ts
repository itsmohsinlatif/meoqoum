...
export const HOME = {
  ...
  sub: {
    en: 'Meo Qoum is a living archive of the Meo community — our gotras, our histories, our mother tongue, and the families who carry them forward in India, Pakistan, and wherever Meos have settled around the world.',
    ur: 'میو قوم میو سماج کا ایک زندہ آرکائیو ہے — ہماری گوتریں، ہماری تاریخ، ہماری ماں بولی، اور وہ خاندان جو اسے ہندوستان، پاکستان اور دنیا بھر میں آگے بڑھاتے ہیں۔',
    mew: 'میو قوم میو لوگاں کو جیتو جاگتو خزانو ہے — ہماری گوتراں، ہماری تواریخ، ہماری ماں بولی، اور وے گھر جو ہندوستان، پاکستان اور دنیا بھر میں اے سب کوں آگے لے کے چلے ہاں۔',
  } as L,
...
export const DIR = {
  ...
  list: [
    {
      name: 'Demrot', urdu: 'ڈَیمروٹ', vansh: 'Surajvanshi · Jado',
      region: { en: 'Alwar–Tijara', ur: 'الور–تیجارہ', mew: 'الور–تیجارہ' } as L,
      clans: 42, villages: 118,
      era: { en: 'Pre-1300', ur: '1300 سے پہلے', mew: '1300 سوں پہلاں' } as L,
      keyVillages: 'Tijara, Tapukara, Kishangarh-Bas, Mundawar, Bansur',
      story: { en: 'The oldest and largest Pal, Demrot traces descent from Tomar Rajputs who held the Tijara region before the Khanzada conversion. Their stronghold at Tapukara was a regional administrative centre in the pre-Mughal era.', ur: 'قدیم ترین اور سب سے بڑا پال، ڈیمروٹ تومار راجپوتوں سے نسب جوڑتا ہے جو خانزادہ تبدیلی سے پہلے تیجارہ علاقے پر قابض تھے۔', mew: 'سب سے پرانو اور سب سے بڑو پال، ڈیمروٹ تومار راجپوتاں سوں نسب جوڑاں ہاں جو خانزادہ سے پہلاں تیجارہ علاقے پر آباد تھے۔' } as L,
    },
    {
      name: 'Poonglot', urdu: 'پُونگلوٹ', vansh: 'Surajvanshi · Jado',
      region: { en: 'Firozpur–Jhirka', ur: 'فیروزپور–جھرکا', mew: 'فیروزپور–جھرکا' } as L,
      clans: 38, villages: 96,
      era: { en: 'Pre-1300', ur: '1300 سے پہلے', mew: '1300 سوں پہلاں' } as L,
      keyVillages: 'Firozpur Jhirka, Tauru, Sohna, Rewasan, Nagina',
      story: { en: 'Concentrated in eastern Nuh district, the Poonglot are traditionally associated with the Sekhawat clan and the historic palace town of Firozpur Jhirka, once a seat of Khanzada power.', ur: 'مشرقی نوح ضلع میں مرتکز، پونگلوٹ روایتی طور پر سیکھاوٹ قبیلے اور تاریخی فیروزپور جھرکا سے منسلک ہیں۔', mew: 'مشرقی نوح ضلع میں آباد، پونگلوٹ سیکھاوٹ خاندان اور تاریخی فیروزپور جھرکا سوں جڑے ہاں۔' } as L,
    },
    {
      name: 'Balot', urdu: 'بَلوٹ', vansh: 'Surajvanshi · Jado',
      region: { en: 'Nuh–Nagina', ur: 'نوح–ناگینہ', mew: 'نوح–ناگینہ' } as L,
      clans: 31, villages: 87,
      era: { en: '1300–1400', ur: '1300–1400', mew: '1300–1400' } as L,
      keyVillages: 'Nagina, Nuh, Indana, Ghaghas, Pingwan',
      story: { en: 'The Balot Pal traces its organisation to Rana Kaku Balot Meo, the 13th-century chief who formalised the thirteen-pal system. Their heartland around Nuh town gives them strategic centrality within Mewat.', ur: 'بلوٹ پال کی تنظیم رانا کاکو بلوٹ میو سے منسوب ہے جنہوں نے تیرہ پال نظام کو باقاعدہ شکل دی۔ نوح شہر کے گرد ان کا مرکز انہیں میوات میں مرکزی اہمیت دیتا ہے۔', mew: 'بلوٹ پال رانا کاکو بلوٹ میو سوں ہے جنہوں نے تیرہ پال نظام بنایو۔ نوح شہر کے گرد ان کو گڑھ ہے۔' } as L,
    },
    {
      name: 'Ratwat', urdu: 'رَتواٹ', vansh: 'Chandravanshi · Chauhan',
      region: { en: 'Bharatpur–Kaman', ur: 'بھرتپور–کامان', mew: 'بھرتپور–کامان' } as L,
      clans: 27, villages: 74,
      era: { en: '1300–1400', ur: '1300–1400', mew: '1300–1400' } as L,
      keyVillages: 'Kaman, Pahari, Deeg, Mahua, Bayana',
      story: { en: 'Of Chauhan Rajput descent, the Ratwat are concentrated in western Bharatpur and around the historic town of Kaman, home to the medieval Chaura Masjid. They are known for their role in the 1857 uprising.', ur: 'چوہان راجپوت نسل کے، رتواٹ مغربی بھرتپور اور تاریخی کامان کے گرد آباد ہیں جہاں درمیانی دور کی چورا مسجد ہے۔ 1857 میں ان کا کردار مشہور ہے۔', mew: 'چوہان راجپوت نسل کے، رتواٹ مغربی بھرتپور اور تاریخی کامان کے گرد آباد ہاں۔ 1857 میں ان کو کردار مشہور ہے۔' } as L,
    },
    {
      name: 'Sengal', urdu: 'سِنگال', vansh: 'Chandravanshi · Chauhan',
      region: { en: 'Tijara plateau', ur: 'تیجارہ پٹھار', mew: 'تیجارہ پٹھار' } as L,
      clans: 24, villages: 68,
      era: { en: '1400–1500', ur: '1400–1500', mew: '1400–1500' } as L,
      keyVillages: 'Tijara, Kishangarhbas, Behror, Mandawar, Lachmangarh',
      story: { en: 'The Sengal, also classified as Badgujar Rajputs, occupy the Tijara plateau stretching into Alwar district. Several Sengal elders contributed to the oral records compiled by colonial-era ethnographers.', ur: 'سنگال، جنہیں بادگوجر راجپوت بھی کہا جاتا ہے، الور ضلع میں تیجارہ کے پٹھار پر آباد ہیں۔ کئی سنگال بزرگوں نے نوآبادیاتی دور کے محققین کو زبانی روایات فراہم کیں۔', mew: 'سنگال، جنہیں بادگوجر راجپوت بھی کہاں ہاں، الور ضلع میں تیجارہ کے پٹھار پر آباد ہاں۔' } as L,
    },
    {
      name: 'Dulot', urdu: 'دُلوٹ', vansh: 'Surajvanshi · Jado',
      region: { en: 'Sohna–Tauru', ur: 'سوہنا–تاؤرو', mew: 'سوہنا–تاؤرو' } as L,
      clans: 22, villages: 61,
      era: { en: '1400–1500', ur: '1400–1500', mew: '1400–1500' } as L,
      keyVillages: 'Sohna, Tauru, Riwari, Palwal, Hasanpur',
      story: { en: 'The Dulot occupy the fertile Sohna–Tauru corridor, one of the most productive agricultural tracts in Mewat. Their proximity to Delhi historically made them an important buffer community between the capital and the Aravalli hinterland.', ur: 'ڈلوٹ سوہنا–تاؤرو کے زرخیز علاقے میں آباد ہیں جو میوات کی زراعتی پٹی کا حصہ ہے۔ دلی کی قربت نے انہیں دارالحکومت اور اراولی کے درمیان اہم برادری بنایا۔', mew: 'ڈلوٹ سوہنا–تاؤرو کے زرخیز علاقے میں آباد ہاں۔ دلی کی قربت نے اناں کوں دارالحکومت اور اراولی کے بیچ اہم سماج بنایو۔' } as L,
    },
    {
      name: 'Nai', urdu: 'نَئی', vansh: 'Agnivanshi',
      region: { en: 'Punahana–Ferozepur', ur: 'پنہانہ–فیروزپور', mew: 'پنہانہ–فیروزپور' } as L,
      clans: 19, villages: 54,
      era: { en: '1400–1500', ur: '1400–1500', mew: '1400–1500' } as L,
      keyVillages: 'Punahana, Ferozepur Namak, Adbar, Ujina, Hatheen',
      story: { en: 'One of the two Agnivanshi pals, the Nai include the Khokkar and Chaurasia clans with pre-Islamic roots stretching back to the Agnikula Rajput confederacy. Punahana town is their administrative and spiritual centre.', ur: 'دو اگنی ونشی پالوں میں سے ایک، نئی میں کھوکھر اور چوراسیہ شامل ہیں جن کی اسلام سے پہلے کی جڑیں اگنی کلا راجپوت اتحاد تک جاتی ہیں۔', mew: 'دو اگنی ونشی پالاں میں سوں ایک، نئی میں کھوکھر اور چوراسیہ شامل ہاں جن کی جڑاں اسلام سوں پہلاں کی ہاں۔' } as L,
    },
    {
      name: 'Lundawat', urdu: 'لُنداوَت', vansh: 'Surajvanshi · Jado',
      region: { en: 'Hodal–Hathin', ur: 'ہودل–ہتھین', mew: 'ہودل–ہتھین' } as L,
      clans: 18, villages: 49,
      era: { en: '1500–1600', ur: '1500–1600', mew: '1500–1600' } as L,
      keyVillages: 'Hodal, Hathin, Aurangabad, Farrukhnagar, Palhawas',
      story: { en: 'The Lundawat dominate the northern Palwal corridor, long a trade and migration route between Agra and Delhi. The Baghodia sub-clan maintains one of the oldest living oral genealogies in the region.', ur: 'لنداوٹ شمالی پلول کے گلیارے پر غالب ہیں جو آگرہ اور دلی کے درمیان تجارت کا راستہ رہا ہے۔ باگھوڈیا ذیلی قبیلہ علاقے کی قدیم ترین زبانی نسب نامہ رکھتا ہے۔', mew: 'لنداوٹ شمالی پلول کے گلیارے پر آباد ہاں۔ باگھوڈیا خاندان علاقے کی سب سے پرانی زبانی نسب نامہ رکھاں ہاں۔' } as L,
    },
    {
      name: 'Chhirkalot', urdu: 'چِھرکلوٹ', vansh: 'Surajvanshi · Jado',
      region: { en: 'Kotla–Pinangwan', ur: 'کوٹلہ–پنگوان', mew: 'کوٹلہ–پنگوان' } as L,
      clans: 17, villages: 44,
      era: { en: '1500–1600', ur: '1500–1600', mew: '1500–1600' } as L,
      keyVillages: 'Kotla, Pinangwan, Kherla, Adbar, Ujina',
      story: { en: 'A compact pal settled in the hilly scrubland around Kotla, the Chhirkalot have historically been herders and farmers. Their name likely derives from "Chhirkala" — the scattered rocky terrain of their homeland.', ur: 'کوٹلہ کے گرد پتھریلی زمین پر آباد، چھرکلوٹ تاریخی طور پر چرواہے اور کسان رہے ہیں۔ ان کا نام غالباً "چھرکالہ" سے ماخوذ ہے۔', mew: 'کوٹلہ کے گرد پتھریلی زمین پر آباد، چھرکلوٹ تاریخی طور پر چرواہے اور کسان رہے ہاں۔' } as L,
    },
    {
      name: 'Dhengal', urdu: 'ڈھینگل', vansh: 'Agnivanshi',
      region: { en: 'Ferozepur Namak', ur: 'فیروزپور نمک', mew: 'فیروزپور نمک' } as L,
      clans: 15, villages: 41,
      era: { en: '1600–1700', ur: '1600–1700', mew: '1600–1700' } as L,
      keyVillages: 'Ferozepur Namak, Hatheen, Ujina, Palhawas, Rewari',
      story: { en: 'The second Agnivanshi pal, the Dhengal (also spelled Dehangal) are settled around the salt-trade town of Ferozepur Namak — "Namak" meaning salt, reflecting the area\'s historic salt-flat economy.', ur: 'دوسرا اگنی ونشی پال، ڈھینگل نمک کی تجارتی بستی فیروزپور نمک کے گرد آباد ہیں۔ "نمک" نام علاقے کی تاریخی نمک معیشت کی یاد دلاتا ہے۔', mew: 'دوسرو اگنی ونشی پال، ڈھینگل نمک کی تجارتی بستی فیروزپور نمک کے گرد آباد ہاں۔' } as L,
    },
    {
      name: 'Kalisa', urdu: 'کَلیسا', vansh: 'Chandravanshi · Chauhan',
      region: { en: 'Mahendragarh', ur: 'مہندرگڑھ', mew: 'مہندرگڑھ' } as L,
      clans: 13, villages: 36,
      era: { en: '1600–1700', ur: '1600–1700', mew: '1600–1700' } as L,
      keyVillages: 'Mahendragarh, Narnaul, Ateli, Kanina, Nangal Sirohi',
      story: { en: 'The Kalisa are the westernmost Meo pal, settled on the Haryana–Rajasthan border near Mahendragarh. Their Chauhan Rajput ancestry is shared with the Ratwat, and several Kalisa clans retain Rajput titles in oral genealogies.', ur: 'کلیسا سب سے مغربی میو پال ہیں جو ہریانہ–راجستھان سرحد کے قریب مہندرگڑھ کے پاس آباد ہیں۔', mew: 'کلیسا سب سے مغربی میو پال ہاں جو ہریانہ–راجستھان سرحد کے قریب مہندرگڑھ کے پاس آباد ہاں۔' } as L,
    },
    {
      name: 'Dedwal', urdu: 'دیدوال', vansh: 'Surajvanshi · Tomar',
      region: { en: 'Alwar–Rewari belt', ur: 'الور–ریواڑی پٹی', mew: 'الور–ریواڑی پٹی' } as L,
      clans: 12, villages: 33,
      era: { en: '1700–1800', ur: '1700–1800', mew: '1700–1800' } as L,
      keyVillages: 'Rewari, Dharuhera, Bawal, Behror, Alwar',
      story: { en: 'The Dedwal occupy the Alwar–Rewari corridor, a zone that bridges the Meo heartland with the Rajput principality of Alwar. Of Tomar Rajput descent, they share ancestry with the Pahat pal and several Delhi-region Tomar lineages.', ur: 'ڈیدوال الور–ریواڑی گلیارے میں آباد ہیں جو میو مرکز کو الور ریاست سے جوڑتا ہے۔ تومار راجپوت نسل کے، وہ پاہت پال کے ساتھ مشترک نسب رکھتے ہیں۔', mew: 'ڈیدوال الور–ریواڑی گلیارے میں آباد ہاں۔ تومار راجپوت نسل کے، وہ پاہت پال کے سنگ مشترک نسب رکھاں ہاں۔' } as L,
    },
    {
      name: 'Pahat', urdu: 'پاہَت', vansh: 'Surajvanshi · Tomar',
      region: { en: 'Hilly Mewat fringe', ur: 'پہاڑی میوات', mew: 'پہاڑی میوات' } as L,
      clans: 8, villages: 22,
      era: { en: '1700–1800', ur: '1700–1800', mew: '1700–1800' } as L,
      keyVillages: 'Rajgarh, Thanagazi, Ramgarh, Lachmangarh, Neemrana',
      story: { en: 'The smallest pal, the Pahat inhabit the forested hills on the Mewat–Rajasthan fringe near Neemrana. Traditionally described as "the thirteenth inferior pal" in colonial records, scholars now attribute this marginalisation to their geographical remoteness rather than social rank.', ur: 'سب سے چھوٹا پال، پاہت نیمرانہ کے قریب میوات–راجستھان سرحد کی پہاڑیوں میں آباد ہے۔ نوآبادیاتی ریکارڈ میں "تیرہویں کمتر پال" کہا جاتا ہے لیکن علماء اب اس کی وجہ جغرافیائی دوری کو قرار دیتے ہیں۔', mew: 'سب سے چھوٹو پال، پاہت نیمرانہ کے قریب میوات–راجستھان سرحد کی پہاڑیاں میں آباد ہے۔' } as L,
    },
  ],
};
  ...
  pinned: [
    {
      ...
      t: { en: 'Annual Mewat Sahitya Sammelan — Nuh, 24 May 2026', ur: 'سالانہ میوات ادبی اجتماع — نوح، 24 مئی 2026', mew: 'سالانو میوات ادبی اجتماع — نوح، 24 مئی 2026' } as L,
      place: { en: 'Nuh Town Hall, Nuh, Haryana', ur: 'ٹاؤن ہال نوح، ہریانہ', mew: 'ٹاؤن ہال نوح، ہریانہ' } as L,
    },
    {
      kind: { en: 'Gathering', ur: 'اجتماع', mew: 'اکٹّھ' } as L,
      date: '3 Dhul Hijjah · June 8',
      t: { en: 'Meo Youth Conference 2026 — Gurugram, 8 June', ur: 'میو یوتھ کانفرنس 2026 — گروگرام، 8 جون', mew: 'میو یوتھ کانفرنس 2026 — گروگرام، 8 جون' } as L,
      place: { en: 'Gurugram Convention Centre, Haryana', ur: 'گروگرام کنونشن سنٹر، ہریانہ', mew: 'گروگرام کنونشن سنٹر، ہریانہ' } as L,
    },
    {
      kind: { en: 'Obituary', ur: 'وفات', mew: 'وفات' } as L,
      date: '8 Shawwal · May 20',
      t: { en: 'Chaudhary Yasin Khan Demrot of Tijara — passed at 84', ur: 'چودھری یاسین خان ڈَیمروٹ تیجارہ — 84 برس کی عمر میں رحلت', mew: 'چودھری یاسین خان ڈَیمروٹ تیجارہ — 84 سال کی عمر میں چل بسے' } as L,
      place: { en: 'Tijara, Alwar', ur: 'تیجارہ، الور', mew: 'تیجارہ، الور' } as L,
    },
    {
      kind: { en: 'Wedding', ur: 'شادی', mew: 'بیاہ' } as L,
      date: '1 Shawwal · May 13',
      t: { en: 'Nikah of Bilal Poonglot & Ayesha Ratwat', ur: 'بلال پونگلوٹ و عائشہ رتواٹ کا نکاح', mew: 'بلال پونگلوٹ اور عائشہ رتواٹ کو نکاح' } as L,
      place: { en: 'Punahana, Nuh', ur: 'پنہانہ، نوح', mew: 'پنہانہ، نوح' } as L,
    },
    {
      kind: { en: 'Notice', ur: 'اعلان', mew: 'اعلان' } as L,
      date: 'Ongoing',
      t: { en: 'Gotra Registration Drive — document your family line before Eid ul-Adha', ur: 'گوتر رجسٹریشن مہم — عید الاضحیٰ سے پہلے اپنے خاندان کا نسب محفوظ کریں', mew: 'گوتر رجسٹریشن مہم — عید الاضحیٰ سوں پہلاں اپنے گھر کو نسب محفوظ کرو' } as L,
      place: { en: 'Online · editors@meoqoum.com', ur: 'آن لائن · editors@meoqoum.com', mew: 'آن لائن · editors@meoqoum.com' } as L,
    },
    {
      kind: { en: 'Notice', ur: 'اعلان', mew: 'اعلان' } as L,
      date: 'Ongoing',
  ...
  feed: [
    {
      ...
      date:   'May 5, 2026',
      img:    'cld-sample-5',
      t:      { en: 'How the Demrot of Alwar trace their line to the pre-Khanzada era', ur: 'الور کے ڈَیمروٹ اپنا نسب خانزادہ سے پہلے کے دور تک کیسے جوڑتے ہیں', mew: 'الور کے ڈَیمروٹ اپنو نسب خانزادہ سوں پہلاں کے دور تک کیسے جوڑاں ہاں' } as L,
      ex:     { en: 'Three panchayat manuscripts, a tax-roll fragment, and a family memoir converge on a single Aravalli village in Tijara tehsil.', ur: 'تین پنچایتی نسخے، ایک پرانا محصول کا کاغذ، اور ایک خاندانی یادداشت — سب ایک ہی اراولی گاؤں پر آ ٹھہرتے ہیں۔', mew: 'تین پنچائتی کتاب، ایک پرانو محصول کو کاغذ، اور ایک گھر کی یادداشت — سب ایک ہی اراولی گاؤں پر آ کے رکاں۔' } as L,
      author: 'Dr. Riyaz Khan',
    ...
    },
    {
      ...
      date:   'April 22, 2026',
      img:    'cld-sample-2',
      t:      { en: "Crossings of '47: voices from both sides of the Radcliffe Line", ur: '47 کی ہجرت: سرحد کے دونوں طرف سے آوازیں', mew: '47 کی ہجرت: سرحد کے دوناں اور سوں آوازاں' } as L,
      ex:     { en: 'An oral-history project gathers eight Meo families separated by Partition — some in Nuh, some in Lahore — and weaves their accounts into a single record for the first time.', ur: 'ایک زبانی تاریخ کا منصوبہ تقسیم سے بچھڑے آٹھ میو خاندانوں کی روایات کو ایک ریکارڈ میں جمع کرتا ہے۔', mew: 'ایک زبانی تواریخ کو منصوبو تقسیم سوں بچھڑے آٹھ گھراں کی باتاں کوں ایک کاغذ میں جمع کراں ہے۔' } as L,
      author: 'Salma Mewati',
    ...
    },
    {
      ...
      date:   'April 14, 2026',
      img:    'cld-sample-4',
      t:      { en: "Reading Mewati: a beginner's guide for young Meos everywhere", ur: 'میواتی پڑھنا: ہر جگہ کے نوجوان میوؤں کے لیے ابتدائی رہنما', mew: 'میواتی پڑھنو: ہر جگہ کے نوجوان میواں کے لیے شروعاتی کتاب' } as L,
      ex:     { en: 'Twelve distinct sounds, three vowel patterns, and a handful of grammatical quirks separate Mewati from standard Urdu. This guide maps them all — for learners in India, Pakistan, and anywhere in the world.', ur: 'بارہ آوازیں، تین مصوتے، اور چند نحوی فرق میواتی کو اردو سے الگ کرتے ہیں — ہندوستان، پاکستان اور دنیا بھر کے سیکھنے والوں کے لیے مکمل رہنما۔', mew: 'بارہ آوازاں، تین مصوتے، اور چند گرامر کے فرق میواتی کوں اردو سوں الگ کراں ہاں — ہندوستان، پاکستان اور دنیا بھر کے سیکھنے والاں کے لیے پورو نقشو۔' } as L,
      author: 'Maulvi A. Mev',
      read:   { en: '7 min read', ur: '7 منٹ', mew: '7 منٹ' } as L,
    },
    {
      cat:    { en: 'Heritage', ur: 'ورثہ', mew: 'ورسو' } as L,
      date:   'April 8, 2026',
      img:    'cld-sample-3',
      t:      { en: 'The Kaman Mosque: 700 years of worship in the heart of Mewat', ur: 'کامان کی مسجد: میوات کے قلب میں 700 سال کی عبادت', mew: 'کامان کی مسجد: میوات کے دل میں 700 سال کی عبادت' } as L,
      ex:     { en: 'Built during the reign of Firuz Shah Tughluq and renovated under the Khanzadas, Kaman Mosque in Bharatpur district remains the spiritual anchor of the eastern Meo belt. A photo essay.', ur: 'فیروز شاہ تغلق کے دور میں تعمیر اور خانزادوں کے زمانے میں تجدید — بھرتپور ضلع کی کامان مسجد مشرقی میو علاقے کا روحانی مرکز ہے۔', mew: 'فیروز شاہ تغلق کے دور میں بنی اور خانزادوں نے سنوارا — بھرتپور ضلع کی کامان مسجد مشرقی میو علاقے کی روح ہے۔' } as L,
      author: 'Arshad Faruqi',
      read:   { en: '8 min read', ur: '8 منٹ', mew: '8 منٹ' } as L,
    },
    {
      cat:    { en: 'Community', ur: 'کمیونٹی', mew: 'سماج' } as L,
      date:   'March 30, 2026',
      img:    'cld-sample',
      t:      { en: '2,400 Meo families documented in the gotra registration drive', ur: 'گوتر رجسٹریشن مہم میں 2,400 میو خاندان ریکارڈ', mew: 'گوتر رجسٹریشن مہم میں 2,400 میو گھر ریکارڈ' } as L,
      ex:     { en: 'Volunteers across Nuh, Alwar and Bharatpur districts documented 2,400 families in three months — mapping five previously unrecorded Sengal sub-clans and correcting gotra spellings standardised by the 1901 census.', ur: 'نوح، الور اور بھرتپور کے رضاکاروں نے تین ماہ میں 2,400 خاندانوں کا ریکارڈ بنایا — پانچ نئے سنگال ذیلی گوتر دریافت کیے۔', mew: 'نوح، الور اور بھرتپور کے رضاکاراں نے تین ماہ میں 2,400 گھراں کو ریکارڈ بنایو — پانچ نئے سنگال ذیلی گوتر دریافت کیے۔' } as L,
      author: 'Meo Qoum Editorial',
      read:   { en: '5 min read', ur: '5 منٹ', mew: '5 منٹ' } as L,
    },
    {
      cat:    { en: 'Culture', ur: 'ثقافت', mew: 'تہذیب' } as L,
      date:   'March 18, 2026',
      img:    'cld-sample-2',
      t:      { en: "The Mewati wedding song (Sehra): why scholars want it on UNESCO's intangible heritage list", ur: 'میواتی شادی کا سہرا: علماء یونیسکو کی فہرست میں شامل کرانا چاہتے ہیں', mew: 'میواتی بیاہ کو سہرو: عالم یونیسکو کی فیرست میں شامل کرانو چاہاں ہاں' } as L,
      ex:     { en: 'The Sehra sung at Meo weddings is a distinct 12-stanza oral tradition with a unique pentatonic melody not found in neighbouring Rajasthani or Braj folk music. Linguists and ethnomusicologists are building the case.', ur: 'میو شادیوں میں گایا جانے والا سہرا ایک منفرد 12 بند کی زبانی روایت ہے جو پڑوسی راجستھانی یا برج موسیقی میں نہیں پائی جاتی۔', mew: 'میو بیاہاں میں گائے جانے والو سہرو 12 بنداں کی روایت ہے جو پڑوسی راجستھانی یا برج موسیقی میں نہیں ملتی۔' } as L,
      author: 'Prof. Irfan Habib',
      read:   { en: '11 min read', ur: '11 منٹ', mew: '11 منٹ' } as L,
    },
  ],
};
...
export const JOIN = {
  ...
  s6: { en: 'Photos (max 2)',          ur: 'تصویریں (زیادہ سے زیادہ 2)', mew: 'تصویراں (زیادہ سے زیادہ 2)' } as L,
  s7: { en: 'Social Media & Contact', ur: 'سوشل میڈیا و رابطہ',    mew: 'سوشل میڈیا و رابطہ' } as L,
  /* labels */
  ...
  uploadPic:     { en: 'Upload Photo 1',      ur: 'پہلی تصویر اپ لوڈ کریں', mew: 'پہلی تصویر اپ لوڈ کرو' } as L,
  uploadPic2:    { en: 'Upload Photo 2',      ur: 'دوسری تصویر اپ لوڈ کریں',mew: 'دوسری تصویر اپ لوڈ کرو'} as L,
  whatsapp:      { en: 'WhatsApp Number',     ur: 'واٹس ایپ نمبر',           mew: 'واٹس ایپ نمبر'         } as L,
  facebook:      { en: 'Facebook Profile URL',ur: 'فیس بک پروفائل لنک',      mew: 'فیس بک پروفائل لنک'   } as L,
  instagram:     { en: 'Instagram Username',  ur: 'انسٹاگرام یوزر نیم',      mew: 'انسٹاگرام یوزر نیم'   } as L,
  linkedin:      { en: 'LinkedIn Profile URL',ur: 'لنکڈ ان پروفائل لنک',     mew: 'لنکڈ ان پروفائل لنک'  } as L,
  twitter:       { en: 'X / Twitter Handle', ur: 'ایکس / ٹوئٹر ہینڈل',      mew: 'ایکس / ٹوئٹر ہینڈل'  } as L,
  socialNote:    {
    en: 'These are shown to logged-in members on your Rishta profile.',
    ur: 'یہ لنکس لاگ ان ممبران کو آپ کی رشتہ پروفائل پر دکھائے جائیں گے۔',
    mew: 'یہ لنکس لاگ ان ممبراں کوں تمہاری رشتہ پروفائل پر دکھائے جائیں گے۔',
  } as L,
...
export const POPULATION = {
  ...
  sub: {
    en: 'The Meo community spans India and Pakistan as two distinct national communities — plus Meos who have settled abroad. Data from the 2011 Indian Census and 2023 Pakistan Census.',
    ur: 'میو قوم ہندوستان اور پاکستان میں دو الگ قومی برادریوں کے طور پر موجود ہے — اس کے علاوہ وہ میو جو دنیا میں کہیں اور بس گئے ہیں۔ 2011 بھارتی اور 2023 پاکستانی مردم شماری کے اعداد و شمار۔',
    mew: 'میو قوم ہندوستان اور پاکستان میں دو الگ قومی برادریاں ہاں — اس کے علاوہ وے میو جو دنیا میں کہیں اور بس گئے ہاں۔ 2011 بھارتی اور 2023 پاکستانی مردم شماری کے اعداد و شمار۔',
  } as L,
  ...
  recognitionBody: {
    en: 'In 1947, Partition divided the Meo homeland. Around 193,000 Meos became part of Pakistan — today a fully Pakistani community with roots in Mewat. After 76 years of advocacy, the 2023 Pakistan Census officially counted Mewati as a distinct language, giving Pakistani Meos a formal linguistic identity for the first time.',
    ur: '۱۹۴۷ میں تقسیم نے میوات کو دو حصوں میں بانٹ دیا۔ تقریباً ۱۹۳,۰۰۰ میو پاکستان کا حصہ بن گئے — آج وہ میوات کی جڑوں سے جڑے مکمل پاکستانی ہیں۔ ۷۶ سال کی جدوجہد کے بعد ۲۰۲۳ کی مردم شماری میں پہلی بار میواتی کو باضابطہ زبان تسلیم کیا گیا۔',
    mew: '۱۹۴۷ میں تقسیم نے میوات کوں دو حصاں میں بانٹ دیو۔ تقریباً ۱۹۳,۰۰۰ میو پاکستان کو حصو بن گئے — آج وے میوات کی جڑاں سوں جڑے مکمل پاکستانی ہاں۔ ۷۶ سال کی محنت کے بعد ۲۰۲۳ کی مردم شماری میں پہلی بار میواتی کوں باضابطہ زبان منیو گیو۔',
  } as L,
  writersTitle: {
    en: 'Literary Revival',
    ur: 'ادبی بیداری',
