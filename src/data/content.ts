...
export const NEWS = {
  ...
  feed: [
    ...
    },
    {
      ...
      ex:     { en: 'Twelve distinct sounds, three vowel patterns, and a handful of grammatical quirks separate Mewati from standard Urdu. This guide maps them all — with audio mnemonics for diaspora learners.', ur: 'بارہ آوازیں، تین مصوتے، اور چند نحوی فرق میواتی کو اردو سے الگ کرتے ہیں — مکمل نقشہ یہاں ہے۔', mew: 'بارہ آوازاں، تین مصوتے، اور چند گرامر کے فرق میواتی کوں اردو سوں الگ کراں ہاں — پورو نقشو یہاں ہے۔' } as L,
      author: 'Maulvi A. Mev',
